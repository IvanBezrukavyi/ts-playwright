...
test.describe("@Demoqa Text Box Tests", () => {
  test("TC 2: E2E. Enter and remove data from input text fields and via keys and shortcuts and cycle", async ({
    ...
    await test.step("Step 7. Click Submit button and Verify absence data after removing it", async () => {
      await textBox.submitTextBoxFormByEnter();
  ...
  test("TC 3: E2E. Enter and remove data from input text fields and via keys and shortcuts", async({page}) => {
    const textBox = new TextBoxPage(page);
    ...
    await test.step("Step 6. Select all data in row and remove it", async () => {
